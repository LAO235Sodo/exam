  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont icon-kaoshi"></i><span class="title">智能在线考试系统</span>
        </div>
        <div class="bottom">
          <div class="container">
            <p class="title">登录</p>
    ...
    <el-row class="footer">
      <el-col>
        <p class="msg2">版权所有 ©2021  保留所有权利  <a href="http://beian.miit.gov.cn/" target="_blank">粤ICP备1900190019号</a></p>
      </el-col>
    </el-row>
...
#login .bg {
  ...
  overflow-y: auto;
  height: 100%;
  background: url('../../assets/img/login2.jpg')center top / cover no-repeat;
